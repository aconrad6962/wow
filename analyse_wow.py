...
class CoilDisableEvent(Event):
    def __init__(self, t, details):
        Event.__init__( self, 'CoilDisabled', t, details)

    @staticmethod
    def fromLogLine(line):
        t = log_timestamp(line)
        return CoilDisableEvent( t, 'Coil Disable command issued')


class FaultRecoveryEvent(Event):
    def __init__(self, t, details):
        Event.__init__( self, 'FaultRecovery', t, details)
